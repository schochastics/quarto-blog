---
title: "Adventures with Rust and R"
author:
  - name: David Schoch
...
Below is the first function I got to work. 
...
`is_valid()` takes a potential phone number and returns TRUE if it is a valid phone number.

```r
is_valid("+4916012345678")
```
