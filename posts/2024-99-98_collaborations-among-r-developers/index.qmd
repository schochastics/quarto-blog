...
```
It is actually quite easy to get all DESCRIPTION data from CRAN. It is a single function call. 
```{r}
#| label: get-cran-data
...
[script](https://github.com/schochastics/CRAN_collaboration/blob/main/Rscripts/helpers.R) to clean author names