...
`filter` and `select` as much to the front as possible in that case.
...
I did not encounter it in my project but iterative processes are usually prone to have some variable being grown dynamically, which is a bad idea. I have blogged before about not using 
[rbind](https://blog.schochastics.net/posts/2024-02-13_be-kind-dont-rbind/index.html) in these situations. The post also contains some suggestions on how to efficiently deal with such cases.
